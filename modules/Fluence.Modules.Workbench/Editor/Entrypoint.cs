...
using Fluence.Modules.Workbench.Editor.Commands;
...
public sealed class Entrypoint : IModule
{
    ...
    public Task InitializeAsync(IModuleHost host, CancellationToken cancellationToken)
    {
        ...
        host.Services.GetRequiredService<ILocalizationService>()
            .Register(new ResourceManager("Fluence.Modules.Workbench.Editor.Resources.Strings", typeof(Entrypoint).Assembly));
